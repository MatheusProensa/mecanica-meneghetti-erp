...
import { gerarFinanceiroPdf, type ResumoFinanceiro, type DespesaLinha } from "@/lib/gerarFinanceiroPdf";
import type { DadosEmpresa } from "@/lib/business";

export default function ExportarFinanceiroPdf({
  empresa,
  periodoLabel,
  resumo,
  despesas,
  ...
  async function exportar() {
    setGerando(true);
    try {
      const doc = await gerarFinanceiroPdf({ empresa, periodoLabel, resumo, despesas });
