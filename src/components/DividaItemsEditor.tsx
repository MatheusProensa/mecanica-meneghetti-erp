...
export default function DividaItemsEditor({
  initialItens,
}: {
        ...
        {itens.map((item, index) => (
          ...
          >
            <input
              ...
              className="rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 sm:w-40"
            />
            <input
              type="text"
              name="descricao"
            ...
            <div className="flex gap-2">
              <CurrencyInput
                ...
                className="w-full rounded-md border border-gray-300 py-2 pl-9 pr-3 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 sm:w-36"
              />
              <button
                type="button"
